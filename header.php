                ...
                <div class="nav-sections d-flex flex-column w-100">
                    ...
                    <section class="nav-section">
                        ...
                        <ul class="navbar-nav nav-main nav-submenu collapse <?= $matchdayOpen ? 'show' : '' ?> mb-0" id="hubMatchdayNavigation">
                            ...
                            <li class="nav-item"><a class="nav-link <?= activeGroup(['matchday_finance.php', 'matchday_finance_edit.php']) ?>"<?= hub_nav_current(['matchday_finance.php', 'matchday_finance_edit.php']) ?> href="/matchday_finance.php"><i class="fa-solid fa-sterling-sign me-1" aria-hidden="true"></i>Matchday income</a></li>
