...
?>
<link rel="stylesheet" href="/assets/css/facebook-photo-import.css?v=<?= (int) (@filemtime(__DIR__ . '/assets/css/facebook-photo-import.css') ?: time()) ?>">
...
<script src="/assets/js/facebook-photo-import.js?v=<?= (int) (@filemtime(__DIR__ . '/assets/js/facebook-photo-import.js') ?: time()) ?>" defer></script>
