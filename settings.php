    ...
    if (!hub_auth_verify_csrf_token($csrfToken)) {
        ...
        if ($section === 'general') {
            ...
            try {
                ...
                header('Location: /settings.php?tab=general&global_pack_saved=1');
                exit;
            ...
            if ($saveOk) {
                ...
                header('Location: /settings.php?tab=publishing&publishing_section=' . rawurlencode($publishingSection) . '&saved=1' . $preparedQuery);
                exit;
            }
                ...
                <form method="post" class="settings-card hub-form-card mt-4">
                    ...
                    <?php if ($availableTemplatePacks === []): ?>
                        <div class="alert alert-info mt-3 mb-0">
                            Publish a pack in <a class="alert-link" href="/template_packs.php">Template Packs</a> before setting a default.
                        </div>
                    <?php endif; ?>
            ...
            <div class="tab-pane fade show active">
                <form method="post" class="settings-card hub-form-card">
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-4">
                        <a class="btn btn-outline-primary" href="/google-callback.php">Open Google callback</a>
                    </div>
