    ...
    <div class="card hub-table-card people-card" data-person-id="<?= (int) $person['id'] ?>">
        <div class="card-body">
            <div class="people-card__header people-card__header--managed">
                ...
                <?php if ($playerId > 0): ?>
                    <a class="btn btn-sm btn-outline-secondary" href="/player_edit.php?id=<?= $playerId ?>">Open</a>
                <?php endif; ?>
            </div>
                ...
                <div class="people-photo-block people-photo-block--tagged">
                    ...
                    <div class="people-player-reference-grid" aria-label="Tagged match photos">
                        ...
                        <?php if (count($taggedPhotos) > 6): ?>
                            <a class="people-player-reference people-player-reference--count" href="/match_photos.php?person_id=<?= (int) $person['id'] ?>">
...
<div class="people-page">
    ...
    <div class="people-add-panel mb-4">
        ...
        <div class="people-add-panel__form">
            <form method="post" action="/person_save.php" class="row g-3 align-items-end">
                <?= csrf_field() ?>
                    ...
                    <?php foreach ($categoryPeople as $person): ?>
                        <div class="card hub-table-card people-card" data-person-id="<?= (int) $person['id'] ?>">
                            <div class="card-body">
                                ...
                                <div class="player-action-shots-grid people-photos-grid">
                                    <?php foreach ($person['photos'] as $photo): ?>
                                        <div class="player-action-shot">
                                            ...
                                            <form method="post" action="/person_photo_delete.php" class="player-action-shot__remove">
                                                <?= csrf_field() ?>
                                    ...
                                    <?php endforeach; ?>
                                    <form method="post" enctype="multipart/form-data" action="/person_photo_upload.php" class="player-action-shot player-action-shot--add people-photo-upload-form">
                                        <?= csrf_field() ?>
                                ...
                                <form method="post" action="/person_delete.php" class="people-card__delete">
                                    <?= csrf_field() ?>
...
<script src="/assets/js/people.js?v=<?= h((string) filemtime(__DIR__ . '/assets/js/people.js')) ?>" defer></script>
