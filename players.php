...
function renderPlayerSponsorSlotCell(string $slotLabel, ?array $row): string
{
  ...
  if ($outstanding > 0.0001 && $agreementId > 0) {
    $value = "<a href='/sponsorship_agreement.php?id={$agreementId}#stripePaymentCard'
          ...
          <div class="d-flex flex-wrap align-items-center gap-3">
            ...
            <div class="hub-local-actions">
              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                  <a class="dropdown-item" href="/player_graphics.php"><i class="fa-solid fa-image" aria-hidden="true"></i>Player sponsor graphic</a>
                  <a class="dropdown-item" href="/sponsor_graphics.php"><i class="fa-solid fa-users-rectangle" aria-hidden="true"></i>All players sponsor graphic</a>
                  <a class="dropdown-item" href="/player_reference.php"><i class="fa-solid fa-address-card" aria-hidden="true"></i>Quick reference</a>
                  <a class="dropdown-item" href="/player_photos_bulk.php"><i class="fa-solid fa-images" aria-hidden="true"></i>Bulk upload photos</a>
                </div>
              </div>
            </div>
          </div>
