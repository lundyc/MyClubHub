...
<link rel="stylesheet" href="/assets/css/player_graphics.css?v=<?= (int) (@filemtime(__DIR__ . '/assets/css/player_graphics.css') ?: time()) ?>">

<nav class="hub-breadcrumb" aria-label="Breadcrumb"><a href="/players.php">Players</a><i class="fa-solid fa-chevron-right" aria-hidden="true"></i><span aria-current="page">Player sponsor graphic</span></nav>
...
<script src="/assets/js/vendor/dom-to-image-more.min.js"></script>
<script src="/assets/js/player_graphics_editor.js?v=<?= time() ?>"></script>
