                ...
                <div class="rpt-table-card__header">
                    <div>
                        ...
                        <?php if (in_array($reportType, ['payments', 'payment_methods'], true)): ?>
                            <p class="small mb-0"><i class="fa-brands fa-stripe-s" aria-hidden="true"></i> Card payments taken via Stripe appear here with method "Stripe" (and "Stripe refund" for refunds). For transaction status and to issue a refund, use the <a href="/stripe_dashboard.php">Stripe Dashboard</a>.</p>
                        <?php endif; ?>
                    </div>
