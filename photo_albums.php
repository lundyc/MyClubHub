...
/**
 * Photo albums — the club photo galleries shown at /public/gallery.
...
$pageHero = [
    ...
    'actions' => [
        ...
        ['label' => 'View gallery', 'href' => '/public/gallery', 'class' => 'btn btn-outline-secondary btn-sm', 'attrs' => ['target' => '_blank', 'rel' => 'noopener']],
    ],
];
