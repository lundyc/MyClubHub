...
<nav class="hub-breadcrumb" aria-label="Breadcrumb"><a href="/players.php">Players</a><i class="fa-solid fa-chevron-right" aria-hidden="true"></i><span aria-current="page">Bulk photos</span></nav>
...
<div class="player-edit-page">
    <?php if ($assignResults !== null): ?>
        ...
        <a href="/players.php" class="btn btn-brand">Back to players</a>
    <?php elseif ($stagedPhotos): ?>
        <div class="card shadow-sm hub-form-card">
            <div class="card-body">
                ...
                <?php endif; ?>
                <form method="post" action="/player_photos_bulk.php">
                    <?= csrf_field() ?>
                    ...
                    <div class="d-grid d-md-flex hub-actions mt-3">
                        ...
                        <a href="/player_photos_bulk.php" class="btn btn-outline-secondary">Start over</a>
                    </div>
                </form>
            </div>
        </div>
    <?php else: ?>
        <div class="card shadow-sm hub-form-card">
            <div class="card-body">
                ...
                <?php endif; ?>
                <form method="post" enctype="multipart/form-data" action="/player_photos_bulk.php" id="bulkPhotosUploadForm">
                    <?= csrf_field() ?>
