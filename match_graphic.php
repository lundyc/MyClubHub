...
<head>
  ...
  <link rel="stylesheet" href="/assets/css/match_graphic.css">
</head>
      ...
      (function () {
        ...
        downloadButton.addEventListener('click', function () {
          ...
          previewWindow.document.write(
            '<!doctype html><html><head><title>Generating PNG...</title><link rel="stylesheet" href="/assets/css/match_graphic-2.css"></head><body>Generating PNG...</body></html>'
          );
          ...
          Promise.all([waitForFonts(), waitForImages(graphic)]).then(function () {
            ...
            previewWindow.document.write(
              '<!doctype html><html><head><title>Starting XI PNG Preview</title><link rel="stylesheet" href="/assets/css/match_graphic-3.css"></head><body><img src="' + imageUrl + '" alt="Starting XI PNG preview"></body></html>'
            );
            previewWindow.document.close();
          }).catch(function (error) {
            previewWindow.document.write(
              '<!doctype html><html><head><title>PNG Preview Error</title><link rel="stylesheet" href="/assets/css/match_graphic-4.css"></head><body>' + String(error && error.message ? error.message : 'Failed to generate PNG.') + '</body></html>'
            );
            previewWindow.document.close();
          }).finally(function () {
