...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!csrf_check()) {
        ...
        if (!empty($result['ok'])) {
            ...
            header(
                'Location: /match_graphics.php?fixture_id=' . $fixtureId
                . '&season_id=' . $seasonId
...
require_once __DIR__ . '/header.php';
?>
<nav class="hub-breadcrumb" aria-label="Breadcrumb"><a href="/matches.php">Fixtures</a><i class="fa-solid fa-chevron-right" aria-hidden="true"></i><a href="/match.php?id=<?= (int)$fixtureId ?>&amp;season_id=<?= (int)$seasonId ?>"><?= h($opponent) ?></a><i class="fa-solid fa-chevron-right" aria-hidden="true"></i><span aria-current="page">Man of the Match</span></nav>

<link rel="stylesheet" href="/assets/css/player-sponsors-match-player-of-match.css">
