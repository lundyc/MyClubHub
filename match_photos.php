...
<?php endif; ?>
<link rel="stylesheet" href="/assets/css/media-library.css?v=<?= (int) (@filemtime(__DIR__ . '/assets/css/media-library.css') ?: time()) ?>">
...
<div id="mediaLibraryConfig" class="d-none" data-csrf="<?= h(hub_auth_csrf_token()) ?>" data-match-csrf="<?= h($matchCsrfToken) ?>" data-endpoint="/match_photos.php" data-can-manage="<?= $canManageMedia ? '1' : '0' ?>"></div>
<script>
...
<?php endif; ?>
<script src="/assets/js/media-library.js?v=<?= (int) (@filemtime(__DIR__ . '/assets/js/media-library.js') ?: time()) ?>" defer></script>
