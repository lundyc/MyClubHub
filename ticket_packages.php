        ...
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body">
                <form method="post">
                    ...
                    <?php if ($editing): ?><a class="btn btn-outline-secondary mt-3" href="/ticket_packages.php">Cancel</a><?php endif; ?>
                </form>
            </div>
        </div>
    </div>
                        ...
                        <tbody>
                            <?php foreach ($packages as $package): ?>
                                <tr>
                                    ...
                                    <td class="text-end"><a class="btn btn-sm btn-outline-secondary" href="/ticket_packages.php?id=<?= (int) $package['id'] ?>">Edit</a></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
