...
function peoplePersonRow(array $person, bool $showPosition): string
{
    ...
    ob_start();
    ?>
    <tr class="people-row" role="link" tabindex="0" data-href="/club_person.php?id=<?= (int) $person['id'] ?>" aria-label="Open person record: <?= h((string) $person['display_name']) ?>">
...
<div class="hub-section-commandbar">
    ...
    <div class="hub-local-actions"><a class="btn btn-brand btn-sm" href="/club_person.php"><i class="fa-solid fa-plus me-1" aria-hidden="true"></i>Add person</a></div>
</div>
