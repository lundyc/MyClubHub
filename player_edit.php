...
echo '<script src="/assets/js/player_edit.js?v=' . h($playerEditJsVersion) . '" defer></script>';
echo '<script src="/assets/js/player_status_cards.js?v=' . h($playerStatusCardsJsVersion) . '" defer></script>';
?>

<link rel="stylesheet" href="/assets/css/player_edit.css?v=<?= h($playerEditCssVersion) ?>">

<nav class="hub-breadcrumb" aria-label="Breadcrumb"><a href="/players.php">Players</a><i class="fa-solid fa-chevron-right" aria-hidden="true"></i><a href="/player_view.php?id=<?= $id ?>"><?= h($playerName) ?></a><i class="fa-solid fa-chevron-right" aria-hidden="true"></i><span aria-current="page">Edit</span></nav>
    ...
    <div class="card player-edit-primary hub-form-card">
        <div class="player-edit-primary-grid">
          <section class="player-edit-avatar-pane">
            ...
            <form id="avatarUploadForm" method="post" enctype="multipart/form-data" action="/player_avatar_upload.php">
                <?= csrf_field() ?>
            ...
            <div class="player-action-shots-grid">
                <?php foreach ($actionShots as $shot): ?>
                    <div class="player-action-shot">
                        ...
                        <form method="post" action="/player_action_shot_delete.php" class="player-action-shot__remove">
                            <?= csrf_field() ?>
                ...
                <?php endforeach; ?>
                <form method="post" enctype="multipart/form-data" action="/player_action_shot_upload.php" id="actionShotUploadForm" class="player-action-shot player-action-shot--add">
                    <?= csrf_field() ?>
                    <input type="hidden" name="player_id" value="<?= (int) $player['id'] ?>">
