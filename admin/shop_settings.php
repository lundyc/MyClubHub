...
if ($isAdmin && ($_SERVER['REQUEST_METHOD'] ?? 'GET') === 'POST') {
    ...
    try {
        ...
        header('Location: /admin/shop_settings.php' . ($m !== '' ? '?m=' . rawurlencode($m) : ''));
        exit;
    } catch (Throwable $e) {
            ...
            <section class="card hub-panel p-3">
                ...
                <form method="post" class="row g-2">
                    ...
                    <div class="col-12 d-flex gap-2">
                        ...
                        <?php if ($editCode): ?><a class="btn btn-outline-secondary" href="/admin/shop_settings.php">Cancel</a><?php endif; ?>
                    </div>
                </form>
            </section>
        </div>
                    ...
                    <?php foreach ($codes as $c): ?>
                        <tr>
                            ...
                            <td class="text-end text-nowrap">
                                <a class="btn btn-sm btn-outline-secondary" href="/admin/shop_settings.php?code=<?= (int) $c['id'] ?>">Edit</a>
