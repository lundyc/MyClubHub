...
<nav class="hub-mobile-nav d-lg-none" aria-label="Mobile hub navigation">
    ...
    <a class="hub-mobile-nav__item <?= in_array($currentScript, ['matches.php', 'match.php', 'match_starting_11.php', 'match_events.php'], true) ? 'active' : '' ?>" href="/admin/matches.php" <?= in_array($currentScript, ['matches.php', 'match.php', 'match_starting_11.php', 'match_events.php'], true) ? 'aria-current="page"' : '' ?>>
        <i class="fa-solid fa-futbol" aria-hidden="true"></i>
        <span>Match day</span>
    </a>
    <a class="hub-mobile-nav__item <?= in_array($currentScript, ['players.php', 'player_view.php', 'player_edit.php', 'player_add.php'], true) ? 'active' : '' ?>" href="/admin/players.php" <?= in_array($currentScript, ['players.php', 'player_view.php', 'player_edit.php', 'player_add.php'], true) ? 'aria-current="page"' : '' ?>>
        <i class="fa-solid fa-users" aria-hidden="true"></i>
        <span>Players</span>
    </a>
    <a class="hub-mobile-nav__item <?= in_array($currentScript, ['sponsors.php', 'sponsor.php', 'sponsorship_agreements.php', 'sponsorship_agreement.php'], true) ? 'active' : '' ?>" href="/admin/sponsors.php" <?= in_array($currentScript, ['sponsors.php', 'sponsor.php', 'sponsorship_agreements.php', 'sponsorship_agreement.php'], true) ? 'aria-current="page"' : '' ?>>
