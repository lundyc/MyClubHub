...
<link rel="stylesheet" href="/admin/assets/css/player-sponsors-match-poster-2.css?v=<?= (int)(@filemtime(__DIR__ . '/assets/css/player-sponsors-match-poster-2.css') ?: time()) ?>">
</head>
<body>
