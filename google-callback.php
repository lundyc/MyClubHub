...
<div>
    <nav class="hub-breadcrumb" aria-label="Breadcrumb"><a href="/settings.php?tab=calendar">Settings</a><i class="fa-solid fa-chevron-right" aria-hidden="true"></i><span aria-current="page">Google Calendar connection</span></nav>
    ...
    <div class="settings-card mb-4">
        ...
        <div class="settings-form-grid settings-form-grid--single">
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                <a class="btn btn-outline-primary" href="/settings.php?tab=calendar">Back to calendar settings</a>
            </div>
        </div>
    </div>
