...
<?php if ($result !== null): ?>
  <div class="alert alert-success">
    ...
    <div class="mt-2">
      <a class="btn btn-sm btn-outline-success" href="/league_table.php">View Hub table</a>
      <a class="btn btn-sm btn-outline-success" href="/public/table" target="_blank" rel="noopener">View public table</a>
    </div>
  </div>
<?php endif; ?>
